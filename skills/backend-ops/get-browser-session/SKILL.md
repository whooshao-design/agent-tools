...
```bash
node /home/joney/projects/ai/agent-tools/skills/backend-ops/get-browser-session/scripts/browser_session.js --status --url=<url>
```
...
```bash
node /home/joney/projects/ai/agent-tools/skills/backend-ops/get-browser-session/scripts/browser_session.js --doctor
```
